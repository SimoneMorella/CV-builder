            ...
            <div className="flex flex-col gap-[9px]">
                ...
                <div className="flex justify-between gap-[9px] items-center">
                    <input 
                        ...
                        onChange={onInput}
                        maxLength={40}
                        className="w-[70%] p-3 max-[533px]:py-2 max-[533px]:text-sm rounded-xl outline-none bg-darkCop transition duration-300 ease-in-out focus:bg-inputFocus hover:bg-inputFocus" />
                    <div>
                        <label 
                            htmlFor="file"
                            className=" max-[533px]:p-1 p-3 max-[533px]:text-xs flex gap-1 items-center bg-white text-darkCop font-semibold rounded-xl cursor-pointer transition shadow-unpressed active:shadow-pressed active:scale-95 hover:shadow-pressed"
                        >
